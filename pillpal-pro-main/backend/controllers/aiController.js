...
const getInsights = asyncHandler(async (req, res) => {
    ...
    if (mostMissed) {
        insights.push({
            type: 'Pattern',
            message: `You frequently miss ${mostMissed}. Consider changing the schedule or setting a stronger reminder.`,
            severity: 'High'
        });
    } else {
        insights.push({
            type: 'Positive',
            message: 'Great job! You have very few missed doses recently.',
            severity: 'Low'
        });
    }
